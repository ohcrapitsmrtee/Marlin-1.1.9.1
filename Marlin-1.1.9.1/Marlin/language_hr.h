...
#define MSG_LEVEL_BED_WAITING               _UxGT("Klikni za po膷etak")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("Sljede膰a to膷ka")
...
#define MSG_SET_ORIGIN                      _UxGT("Postavi ishodi拧te")
...
#define MSG_COOLDOWN                        _UxGT("Hla膽enje")
#define MSG_SWITCH_PS_ON                    _UxGT("Uklju膷i napajanje")
#define MSG_SWITCH_PS_OFF                   _UxGT("Isklju膷i napajanje")
#define MSG_EXTRUDE                         _UxGT("Extrude")
#define MSG_RETRACT                         _UxGT("Retract")
#define MSG_MOVE_AXIS                       _UxGT("Mi膷i os")
#define MSG_BED_LEVELING                    _UxGT("Niveliraj bed")
#define MSG_LEVEL_BED                       _UxGT("Niveliraj bed")
#define MSG_MOVE_X                          _UxGT("Mi膷i X")
#define MSG_MOVE_Y                          _UxGT("Mi膷i Y")
#define MSG_MOVE_Z                          _UxGT("Mi膷i Z")
#define MSG_MOVE_E                          _UxGT("Extruder")
#define MSG_MOVE_01MM                       _UxGT("Mi膷i 0.1mm")
#define MSG_MOVE_1MM                        _UxGT("Mi膷i 1mm")
#define MSG_MOVE_10MM                       _UxGT("Mi膷i 10mm")
...
#define MSG_LOAD_EEPROM                     _UxGT("U膷itaj memoriju")
#define MSG_RESTORE_FAILSAFE                _UxGT("U膷itaj failsafe")
#define MSG_REFRESH                         _UxGT("Osvje啪i")
...
#define MSG_USERWAIT                        _UxGT("膶ekaj korisnika...")
...
#define MSG_HEATING_FAILED_LCD              _UxGT("Grijanje neuspje拧no")
...
#define MSG_DELTA_CALIBRATE_CENTER          _UxGT("Kalibriraj Sredi拧te")
...
#define MSG_CASE_LIGHT                      _UxGT("Osvjetljenje")
  ...
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Zavr拧eni")
  #define MSG_INFO_PRINT_TIME               _UxGT("Ukupno printanja")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Najdu啪i print")
  ...
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Najdu啪i")
...
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Nastavi print")
  ...
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("膶ekaj po膷etak")
  #define MSG_FILAMENT_CHANGE_INIT_2          _UxGT("filamenta")
  #define MSG_FILAMENT_CHANGE_INIT_3          _UxGT("promijeni")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("膶ekaj")
  ...
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("Pri膷ekaj")
  #define MSG_FILAMENT_CHANGE_LOAD_2          _UxGT("filament load")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Wait for print")
  #define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("to resume")
#else // LCD_HEIGHT < 4
  // Up to 2 lines allowed
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Pri膷ekaj...")
