...
class Stepper {
  ...
  private:
    ...
    #if ENABLED(S_CURVE_ACCELERATION)
      static int32_t bezier_A,     // A coefficient in B茅zier speed curve
                     bezier_B,     // B coefficient in B茅zier speed curve
                     bezier_C;     // C coefficient in B茅zier speed curve
      static uint32_t bezier_F,    // F coefficient in B茅zier speed curve
                      bezier_AV;   // AV coefficient in B茅zier speed curve
      static bool A_negative,      // If A coefficient was negative
                  bezier_2nd_half; // If B茅zier curve has been initialized or not
    #endif
