...
#define MSG_TMC_Z_CALIBRATION               _UxGT("Z銈搞偗 銈炽偊銈汇偆")                 // "Calibrate Z"
...
#if IS_KINEMATIC
  #define MSG_VA_JERK                       _UxGT("A銈搞偗 銉ゃ偗銉� mm/s")             // "Va-jerk"
  #define MSG_VB_JERK                       _UxGT("B銈搞偗 銉ゃ偗銉� mm/s")             // "Vb-jerk"
  #define MSG_VC_JERK                       _UxGT("C銈搞偗 銉ゃ偗銉� mm/s")             // "Vc-jerk"
#else
  #define MSG_VA_JERK                       _UxGT("X銈搞偗 銉ゃ偗銉� mm/s")             // "Vx-jerk"
  #define MSG_VB_JERK                       _UxGT("Y銈搞偗 銉ゃ偗銉� mm/s")             // "Vy-jerk"
  #define MSG_VC_JERK                       _UxGT("Z銈搞偗 銉ゃ偗銉� mm/s")             // "Vz-jerk"
#endif
