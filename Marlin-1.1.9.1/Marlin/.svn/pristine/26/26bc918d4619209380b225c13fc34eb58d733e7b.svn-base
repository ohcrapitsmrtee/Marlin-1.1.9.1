...
#define MSG_TMC_Z_CALIBRATION               _UxGT("袣邪谢懈斜褉芯胁泻邪 Z")
...
#if IS_KINEMATIC
  #define MSG_ASTEPS                        _UxGT("A褋褌褗锌泻懈/mm")
  #define MSG_BSTEPS                        _UxGT("B褋褌褗锌泻懈/mm")
  #define MSG_CSTEPS                        _UxGT("C褋褌褗锌泻懈/mm")
#else
  #define MSG_ASTEPS                        _UxGT("X褋褌褗锌泻懈/mm")
  #define MSG_BSTEPS                        _UxGT("Y褋褌褗锌泻懈/mm")
  #define MSG_CSTEPS                        _UxGT("Z褋褌褗锌泻懈/mm")
#endif
