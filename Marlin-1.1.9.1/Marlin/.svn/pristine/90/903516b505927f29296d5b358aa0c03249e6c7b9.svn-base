...
#define MSG_AUTOSTART                       _UxGT("Inicio autom谩tico")
#define MSG_DISABLE_STEPPERS                _UxGT("Apagar motores")
#define MSG_DEBUG_MENU                      _UxGT("Men煤 depurar")
...
#define MSG_LEVEL_BED_DONE                  _UxGT("Nivelaci贸n lista!")
...
#define MSG_ACC                             _UxGT("Aceleraci贸n")
...
#define MSG_WATCH                           _UxGT("Informaci贸n")
#define MSG_PREPARE                         _UxGT("Preparar")
#define MSG_TUNE                            _UxGT("Ajustar")
#define MSG_PAUSE_PRINT                     _UxGT("Pausar impresi贸n")
#define MSG_RESUME_PRINT                    _UxGT("Reanudar impresi贸n")
#define MSG_STOP_PRINT                      _UxGT("Detener impresi贸n")
#define MSG_CARD_MENU                       _UxGT("Men煤 de SD")
#define MSG_NO_CARD                         _UxGT("No hay tarjeta SD")
#define MSG_DWELL                           _UxGT("Reposo...")
#define MSG_USERWAIT                        _UxGT("Esperando 贸rdenes")
#define MSG_PRINT_ABORTED                   _UxGT("Impresi贸n cancelada")
...
#define MSG_AUTORETRACT                     _UxGT("Retracci贸n Auto.")
...
#define MSG_ERR_MAXTEMP                     _UxGT("Error: Temp M谩xima")
#define MSG_ERR_MINTEMP                     _UxGT("Error: Temp M铆nima")
...
#define MSG_INFO_STATS_MENU                 _UxGT("Estad铆sticas Imp.")
...
#if LCD_WIDTH > 19
  #define MSG_INFO_PRINT_COUNT              _UxGT("Conteo de impresi贸n")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Completadas")
  #define MSG_INFO_PRINT_TIME               _UxGT("Tiempo total de imp.")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Impresi贸n m谩s larga")
  #define MSG_INFO_PRINT_FILAMENT           _UxGT("Total de Extrusi贸n")
#else
  #define MSG_INFO_PRINT_COUNT              _UxGT("Impresiones")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Completadas")
  #define MSG_INFO_PRINT_TIME               _UxGT("Total")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("M谩s larga")
  #define MSG_INFO_PRINT_FILAMENT           _UxGT("Extrusi贸n")
#endif

#define MSG_INFO_MIN_TEMP                   _UxGT("Temperatura m铆nima")
#define MSG_INFO_MAX_TEMP                   _UxGT("Temperatura m谩xima")
...
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("Extruir m谩s")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Resumir imp.")

#define MSG_FILAMENT_CHANGE_MINTEMP         _UxGT("Temp M铆nima es ")
...
#define MSG_FILAMENT_CHANGE_INSERT_2        _UxGT("y presione el bot贸n")
...
#define MSG_FILAMENT_CHANGE_HEAT_1          _UxGT("Oprima bot贸n para")
