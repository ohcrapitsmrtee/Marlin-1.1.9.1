...
public:
  ...
  uint16_t get_num_Files();
    ...
    void openJobRecoveryFile(uint8_t index, const bool read);
    void closeJobRecoveryFile(uint8_t index);
    bool jobRecoverFileExists(uint8_t index);
    int16_t saveJobRecoveryInfo(uint8_t index);
    int16_t loadJobRecoveryInfo(uint8_t index);
    void removeJobRecoveryFile(uint8_t index);
  #endif
...
private:
  ...
  #if ENABLED(POWER_LOSS_RECOVERY)
    SdFile jobRecoveryFile0, jobRecoveryFile1;
  #endif
