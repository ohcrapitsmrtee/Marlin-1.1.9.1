...
#define MSG_TMC_Z_CALIBRATION               _UxGT("袣邪谢褨斜褉褍胁邪薪薪褟 Z")
...
#if IS_KINEMATIC
  #define MSG_VA_JERK                       _UxGT("Va-褉懈胁芯泻")
  #define MSG_VB_JERK                       _UxGT("Vb-褉懈胁芯泻")
  #define MSG_VC_JERK                       _UxGT("Vc-褉懈胁芯泻")
#else
  #define MSG_VA_JERK                       _UxGT("Vx-褉懈胁芯泻")
  #define MSG_VB_JERK                       _UxGT("Vy-褉懈胁芯泻")
  #define MSG_VC_JERK                       _UxGT("Vz-褉懈胁芯泻")
#endif
...
#if IS_KINEMATIC
  #define MSG_ASTEPS                        _UxGT("A泻褉芯泻褨胁/屑屑")
  #define MSG_BSTEPS                        _UxGT("B泻褉芯泻褨胁/屑屑")
  #define MSG_CSTEPS                        _UxGT("C泻褉芯泻褨胁/屑屑")
#else
  #define MSG_ASTEPS                        _UxGT("X泻褉芯泻褨胁/屑屑")
  #define MSG_BSTEPS                        _UxGT("Y泻褉芯泻褨胁/屑屑")
  #define MSG_CSTEPS                        _UxGT("Z泻褉芯泻褨胁/屑屑")
#endif
