...
#define MSG_DISABLE_STEPPERS                _UxGT("Sl氓 alle steppere fra")
...
#define MSG_LEVEL_BED_WAITING               _UxGT("Klik n氓r du er klar")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("N忙ste punkt")
#define MSG_LEVEL_BED_DONE                  _UxGT("Bed level er f忙rdig!")
#define MSG_SET_HOME_OFFSETS                _UxGT("S忙t forsk. af home")
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("Forsk. er nu aktiv")
#define MSG_SET_ORIGIN                      _UxGT("S忙t origin")
...
#define MSG_COOLDOWN                        _UxGT("Afk酶l")
#define MSG_SWITCH_PS_ON                    _UxGT("Sl氓 str酶m til")
#define MSG_SWITCH_PS_OFF                   _UxGT("Sl氓 str酶m fra")
...
#define MSG_FAN_SPEED                       _UxGT("Bl忙ser hastighed")
...
#define MSG_MOTION                          _UxGT("Bev忙gelse")
...
#define MSG_USERWAIT                        _UxGT("Venter p氓 bruger...")
#define MSG_PRINT_ABORTED                   _UxGT("Print annulleret")
#define MSG_NO_MOVE                         _UxGT("Ingen bev忙gelse.")
#define MSG_KILLED                          _UxGT("DR脝BT. ")
#define MSG_STOPPED                         _UxGT("STOPPET. ")
#define MSG_CONTROL_RETRACT                 _UxGT("Tilbagetr忙k mm")
#define MSG_CONTROL_RETRACT_SWAP            _UxGT("Skift Re.mm")
#define MSG_CONTROL_RETRACTF                _UxGT("Tilbagetr忙k V")
...
#define MSG_THERMAL_RUNAWAY                 _UxGT("Temp l酶ber l酶bsk")
...
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Fors忙t print")

#if LCD_HEIGHT >= 4
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Vent p氓 start")
  #define MSG_FILAMENT_CHANGE_INIT_2          _UxGT("af filament")
  #define MSG_FILAMENT_CHANGE_INIT_3          _UxGT("skift")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Vent p氓")
  #define MSG_FILAMENT_CHANGE_UNLOAD_2        _UxGT("filament udskyd.")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("Inds忙t filament")
  #define MSG_FILAMENT_CHANGE_INSERT_2        _UxGT("og tryk p氓 knap")
  #define MSG_FILAMENT_CHANGE_INSERT_3        _UxGT("for at forts忙tte...")
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("Vent p氓")
  #define MSG_FILAMENT_CHANGE_LOAD_2          _UxGT("filament indtag")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Vent p氓 at print")
  #define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("forts忙tter")
#else // LCD_HEIGHT < 4
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Vent venligst...")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Udskyder...")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("Inds忙t og klik")
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("Indtager...")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Forts忙tter...")
#endif // LCD_HEIGHT < 4
