...
#define MSG_SD_INSERTED                     _UxGT("Karta w艂o偶ona")
#define MSG_SD_REMOVED                      _UxGT("Karta usuni臋ta")
#define MSG_LCD_ENDSTOPS                    _UxGT("Kranc贸w.") // Max length 8 characters
#define MSG_MAIN                            _UxGT("Menu g艂贸wne")
#define MSG_AUTOSTART                       _UxGT("Autostart")
#define MSG_DISABLE_STEPPERS                _UxGT("Wy艂膮cz silniki")
...
#define MSG_LEVEL_BED                       _UxGT("Poziom. sto艂u")
#define MSG_LEVEL_BED_HOMING                _UxGT("Pozycja zerowa")
#define MSG_LEVEL_BED_WAITING               _UxGT("Kliknij by rozp.")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("Nast臋pny punkt")
#define MSG_LEVEL_BED_DONE                  _UxGT("Wypoziomowano!")
#define MSG_USER_MENU                       _UxGT("W艂asne Polecenia")
...
#define MSG_PREHEAT_1_BEDONLY               _UxGT("Rozgrzej st贸艂 PLA")
...
#define MSG_PREHEAT_2_BEDONLY               _UxGT("Rozgrzej st贸艂 ABS")
#define MSG_PREHEAT_2_SETTINGS              _UxGT("Ustaw. rozg. ABS")
#define MSG_COOLDOWN                        _UxGT("Ch艂odzenie")
#define MSG_SWITCH_PS_ON                    _UxGT("W艂膮cz zasilacz")
#define MSG_SWITCH_PS_OFF                   _UxGT("Wy艂膮cz zasilacz")
#define MSG_EXTRUDE                         _UxGT("Ekstruzja")
#define MSG_RETRACT                         _UxGT("Wycofanie")
#define MSG_MOVE_AXIS                       _UxGT("Ruch osi")
#define MSG_BED_LEVELING                    _UxGT("Poziom. sto艂u")
#define MSG_MOVE_X                          _UxGT("Przesu艅 w X")
#define MSG_MOVE_Y                          _UxGT("Przesu艅 w Y")
#define MSG_MOVE_Z                          _UxGT("Przesu艅 w Z")
#define MSG_MOVE_E                          _UxGT("Ekstruzja (os E)")
#define MSG_MOVE_01MM                       _UxGT("Przesu艅 co .1mm")
#define MSG_MOVE_1MM                        _UxGT("Przesu艅 co 1mm")
#define MSG_MOVE_10MM                       _UxGT("Przesu艅 co 10mm")
#define MSG_SPEED                           _UxGT("Predko艣膰")
#define MSG_BED_Z                           _UxGT("St贸艂 Z")
#define MSG_NOZZLE                          _UxGT("Dysza")
#define MSG_BED                             _UxGT("St贸艂")
#define MSG_FAN_SPEED                       _UxGT("Obroty wiatraka")
#define MSG_FLOW                            _UxGT("Przep艂yw")
#define MSG_CONTROL                         _UxGT("Ustawienia")
#define MSG_MIN                             LCD_STR_THERMOMETER _UxGT(" Min")
#define MSG_MAX                             LCD_STR_THERMOMETER _UxGT(" Max")
#define MSG_FACTOR                          LCD_STR_THERMOMETER _UxGT(" Mno偶nik")
#define MSG_AUTOTEMP                        _UxGT("Auto. temperatura")
#define MSG_ON                              _UxGT("W艂. ")
#define MSG_OFF                             _UxGT("Wy艂.")
#define MSG_PID_P                           _UxGT("PID-P")
#define MSG_PID_I                           _UxGT("PID-I")
#define MSG_PID_D                           _UxGT("PID-D")
#define MSG_PID_C                           _UxGT("PID-C")
#define MSG_SELECT                          _UxGT("Select")
#define MSG_ACC                             _UxGT("Przy艣pieszenie")
...
#define MSG_A_TRAVEL                        _UxGT("A-przesu艅.")
...
#define MSG_FILAMENT_DIAM                   _UxGT("艢r. fil.")
#define MSG_CONTRAST                        _UxGT("Kontrast LCD")
#define MSG_STORE_EEPROM                    _UxGT("Zapisz w pami臋ci")
#define MSG_LOAD_EEPROM                     _UxGT("Wczytaj z pami臋ci")
#define MSG_RESTORE_FAILSAFE                _UxGT("Ustaw. fabryczne")
#define MSG_REFRESH                         _UxGT("Odswie偶")
#define MSG_WATCH                           _UxGT("Ekran g艂贸wny")
...
#define MSG_FILAMENTCHANGE                  _UxGT("Zmie艅 filament")
#define MSG_INIT_SDCARD                     _UxGT("Inicjal. karty SD")
#define MSG_CNG_SDCARD                      _UxGT("Zmiana karty SD")
#define MSG_ZPROBE_OUT                      _UxGT("Sonda Z za sto艂em")
...
#define MSG_ENDSTOP_ABORT                   _UxGT("B艂膮d kra艅c贸wki")
#define MSG_HEATING_FAILED_LCD              _UxGT("Rozgrz. nieudane")
#define MSG_ERR_REDUNDANT_TEMP              _UxGT("B艂膮d temperatury")
...
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Err max temp sto艂u")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Err min temp sto艂u")
#define MSG_ERR_Z_HOMING                    MSG_HOME _UxGT(" ") MSG_X MSG_Y _UxGT(" ") MSG_FIRST
#define MSG_HALTED                          _UxGT("Drukarka zatrzym.")
#define MSG_PLEASE_RESET                    _UxGT("Prosz臋 zresetowa膰")
#define MSG_SHORT_DAY                       _UxGT("d") // One character only
#define MSG_SHORT_HOUR                      _UxGT("g") // One character only
#define MSG_SHORT_MINUTE                    _UxGT("m") // One character only
#define MSG_HEATING                         _UxGT("Rozgrzewanie...")
#define MSG_BED_HEATING                     _UxGT("Rozgrzewanie sto艂u...")
...
#define MSG_DELTA_CALIBRATE_CENTER          _UxGT("Kalibruj 艣rodek")
...
#define MSG_INFO_BAUDRATE                   _UxGT("Predko艣膰 USB")
#define MSG_INFO_PROTOCOL                   _UxGT("Protok贸艂")
#define MSG_CASE_LIGHT                      _UxGT("O艣wietlenie")

#if LCD_WIDTH >= 20
  #define MSG_INFO_PRINT_COUNT              _UxGT("Wydrukowano")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Uko艅czono")
  #define MSG_INFO_PRINT_TIME               _UxGT("Czas druku")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Najd艂. druk")
  #define MSG_INFO_PRINT_FILAMENT           _UxGT("U偶yty fil.")
#else
  #define MSG_INFO_PRINT_COUNT              _UxGT("Wydrukowano")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Uko艅czono")
...
#define MSG_DRIVE_STRENGTH                  _UxGT("Si艂a silnika")
#define MSG_DAC_PERCENT                     _UxGT("Si艂a %")
#define MSG_DAC_EEPROM_WRITE                _UxGT("Zapisz DAC EEPROM")

#define MSG_FILAMENT_CHANGE_HEADER_PAUSE    _UxGT("ZMIE艃 FILAMENT")
#define MSG_FILAMENT_CHANGE_OPTION_HEADER   _UxGT("ZMIE艃 OPCJE:")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Wzn贸w drukowanie")

#if LCD_HEIGHT >= 4
  // Up to 3 lines allowed
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Czekam na ")
  #define MSG_FILAMENT_CHANGE_INIT_2          _UxGT("zmian臋 filamentu")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Czekam na")
  #define MSG_FILAMENT_CHANGE_UNLOAD_2        _UxGT("wyj臋cie filamentu")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("W艂贸z filament")
  #define MSG_FILAMENT_CHANGE_INSERT_2        _UxGT("i naci艣nij przycisk")
  #define MSG_FILAMENT_CHANGE_INSERT_3        _UxGT("aby kontynuowa膰...")
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("Czekam na")
  #define MSG_FILAMENT_CHANGE_LOAD_2          _UxGT("w艂o偶enie filamentu")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Czekam na")
  #define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("wznowienie druku")
#else // LCD_HEIGHT < 4
  // Up to 2 lines allowed
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Prosz臋 czeka膰...")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Wysuwanie...")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("W艂贸偶 i naci艣nij prz.")
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("艁adowanie...")
