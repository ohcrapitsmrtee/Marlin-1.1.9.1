...
#define MSG_PREHEAT_1                       _UxGT("Esil盲mmit盲 PLA")
#define MSG_PREHEAT_1_N                     _UxGT("Esil盲mmit盲 PLA ")
#define MSG_PREHEAT_1_ALL                   _UxGT("Esil盲. PLA Kaikki")
#define MSG_PREHEAT_1_BEDONLY               _UxGT("Esil盲. PLA Alusta")
#define MSG_PREHEAT_1_SETTINGS              _UxGT("Esil盲mm. PLA konf")
#define MSG_PREHEAT_2                       _UxGT("Esil盲mmit盲 ABS")
#define MSG_PREHEAT_2_N                     _UxGT("Esil盲mmit盲 ABS ")
#define MSG_PREHEAT_2_ALL                   _UxGT("Esil盲. ABS Kaikki")
#define MSG_PREHEAT_2_BEDONLY               _UxGT("Esil盲. ABS Alusta")
#define MSG_PREHEAT_2_SETTINGS              _UxGT("Esil盲mm. ABS konf")
#define MSG_COOLDOWN                        _UxGT("J盲盲hdyt盲")
#define MSG_SWITCH_PS_ON                    _UxGT("Virta p盲盲lle")
#define MSG_SWITCH_PS_OFF                   _UxGT("Virta pois")
#define MSG_EXTRUDE                         _UxGT("Pursota")
#define MSG_RETRACT                         _UxGT("Ved盲 takaisin")
...
#define MSG_TEMPERATURE                     _UxGT("L盲mp枚tila")
#define MSG_MOTION                          _UxGT("Liike")
#define MSG_FILAMENT                        _UxGT("Filament")
#define MSG_VOLUMETRIC_ENABLED              _UxGT("E in mm鲁")
...
#define MSG_REFRESH                         _UxGT("P盲ivit盲")
#define MSG_WATCH                           _UxGT("Seuraa")
#define MSG_PREPARE                         _UxGT("Valmistele")
#define MSG_TUNE                            _UxGT("S盲盲d盲")
#define MSG_PAUSE_PRINT                     _UxGT("Keskeyt盲 tulostus")
#define MSG_RESUME_PRINT                    _UxGT("Jatka tulostusta")
#define MSG_STOP_PRINT                      _UxGT("Pys盲yt盲 tulostus")
...
#define MSG_CONTROL_RETRACT                 _UxGT("Ved盲 mm")
#define MSG_CONTROL_RETRACT_SWAP            _UxGT("Va. Ved盲 mm")
#define MSG_CONTROL_RETRACTF                _UxGT("Ved盲 V")
