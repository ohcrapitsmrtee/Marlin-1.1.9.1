...
#define WELCOME_MSG                         MACHINE_NAME _UxGT(" pr锚te.")
#define MSG_BACK                            _UxGT("Retour")
#define MSG_SD_INSERTED                     _UxGT("Carte ins茅r茅e")
#define MSG_SD_REMOVED                      _UxGT("Carte retir茅e")
#define MSG_LCD_ENDSTOPS                    _UxGT("But茅es") // Max length 8 characters
#define MSG_MAIN                            _UxGT("Menu principal")
#define MSG_AUTOSTART                       _UxGT("Demarrage auto")
#define MSG_DISABLE_STEPPERS                _UxGT("Arr锚ter moteurs")
...
#define MSG_LEVEL_BED_DONE                  _UxGT("Mise 脿 niveau OK!")
#define MSG_Z_FADE_HEIGHT                   _UxGT("Hauteur liss茅e")
#define MSG_SET_HOME_OFFSETS                _UxGT("R茅gl. d茅cal. origine")
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("D茅calages appliqu茅s")
#define MSG_SET_ORIGIN                      _UxGT("R茅gler origine")
#define MSG_PREHEAT_1                       _UxGT("Pr茅chauffage PLA")
#define MSG_PREHEAT_1_N                     _UxGT("Pr茅chauff. PLA ")
#define MSG_PREHEAT_1_ALL                   _UxGT("Pr茅ch. PLA Tout")
#define MSG_PREHEAT_1_END                   MSG_PREHEAT_1 _UxGT(" fini")
#define MSG_PREHEAT_1_BEDONLY               _UxGT("Pr茅ch. PLA lit")
#define MSG_PREHEAT_1_SETTINGS              _UxGT("R茅gl. prech. PLA")
#define MSG_PREHEAT_2                       _UxGT("Pr茅chauffage ABS")
#define MSG_PREHEAT_2_N                     _UxGT("Pr茅chauff. ABS ")
#define MSG_PREHEAT_2_ALL                   _UxGT("Pr茅ch. ABS Tout")
#define MSG_PREHEAT_2_END                   MSG_PREHEAT_2 _UxGT(" fini")
#define MSG_PREHEAT_2_BEDONLY               _UxGT("Pr茅ch. ABS lit")
#define MSG_PREHEAT_2_SETTINGS              _UxGT("R茅gl. prech. ABS")
...
#define MSG_MOVE_AXIS                       _UxGT("D茅placer un axe")
#define MSG_BED_LEVELING                    _UxGT("R茅gl. Niv. lit")
#define MSG_LEVEL_BED                       _UxGT("R茅gl. Niv. lit")
#define MSG_LEVEL_CORNERS                   _UxGT("Niveau coins")
#define MSG_NEXT_CORNER                     _UxGT("Coin suivant")
#define MSG_EDITING_STOPPED                 _UxGT("Arr锚t 茅dit. maillage")
...
#define MSG_UBL_LEVEL_BED                   _UxGT("Niveau lit unifi茅")
#define MSG_UBL_MANUAL_MESH                 _UxGT("Maillage manuel")
#define MSG_UBL_BC_INSERT                   _UxGT("Poser c芒le & mesurer")
#define MSG_UBL_BC_INSERT2                  _UxGT("Mesure")
#define MSG_UBL_BC_REMOVE                   _UxGT("么ter et mesurer lit")
#define MSG_UBL_MOVING_TO_NEXT              _UxGT("Aller au suivant")
#define MSG_UBL_ACTIVATE_MESH               _UxGT("Activer l'UBL")
#define MSG_UBL_DEACTIVATE_MESH             _UxGT("D茅sactiver l'UBL")
#define MSG_UBL_SET_BED_TEMP                _UxGT("Temp茅rature lit")
#define MSG_UBL_CUSTOM_BED_TEMP             MSG_UBL_SET_BED_TEMP
#define MSG_UBL_SET_HOTEND_TEMP             _UxGT("Temp茅rature buse")
#define MSG_UBL_CUSTOM_HOTEND_TEMP          MSG_UBL_SET_HOTEND_TEMP
#define MSG_UBL_MESH_EDIT                   _UxGT("Editer maille")
#define MSG_UBL_EDIT_CUSTOM_MESH            _UxGT("Editer maille perso")
#define MSG_UBL_FINE_TUNE_MESH              _UxGT("R茅glage fin maille")
#define MSG_UBL_DONE_EDITING_MESH           _UxGT("Terminer maille")
#define MSG_UBL_BUILD_CUSTOM_MESH           _UxGT("Cr茅er maille perso")
#define MSG_UBL_BUILD_MESH_MENU             _UxGT("Cr茅er maille")
#define MSG_UBL_BUILD_PLA_MESH              _UxGT("Cr茅er maille PLA")
#define MSG_UBL_BUILD_ABS_MESH              _UxGT("Cr茅er maille ABS")
#define MSG_UBL_BUILD_COLD_MESH             _UxGT("Cr茅er maille froide")
...
#define MSG_UBL_INVALIDATE_CLOSEST          _UxGT("Annuler le plus pr猫s")
#define MSG_UBL_FINE_TUNE_ALL               _UxGT("R茅glage fin (tous)")
#define MSG_UBL_FINE_TUNE_CLOSEST           _UxGT("R茅glage fin (proche)")
#define MSG_UBL_STORAGE_MESH_MENU           _UxGT("Stockage maille")
#define MSG_UBL_STORAGE_SLOT                _UxGT("Slot m茅moire")
...
#define MSG_NO_STORAGE                      _UxGT("Pas de m茅moire")
#define MSG_UBL_SAVE_ERROR                  _UxGT("Err: Enreg. UBL")
#define MSG_UBL_RESTORE_ERROR               _UxGT("Err: Ouvrir UBL")
#define MSG_UBL_Z_OFFSET_STOPPED            _UxGT("D茅cal. Z arr锚t茅")
#define MSG_UBL_STEP_BY_STEP_MENU           _UxGT("UBL Pas 脿 pas")

#define MSG_LED_CONTROL                     _UxGT("Contr么le LED")
#define MSG_LEDS                            _UxGT("Lumi猫re")
#define MSG_LED_PRESETS                     _UxGT("Pr茅regl. LED")
...
#define MSG_INTENSITY_R                     _UxGT("Intensit茅 rouge")
#define MSG_INTENSITY_G                     _UxGT("Intensit茅 vert")
#define MSG_INTENSITY_B                     _UxGT("Intensit茅 bleu")
#define MSG_INTENSITY_W                     _UxGT("Intensit茅 blanc")
#define MSG_LED_BRIGHTNESS                  _UxGT("Luminosit茅")

#define MSG_MOVING                          _UxGT("D茅placement...")
#define MSG_FREE_XY                         _UxGT("D茅bloquer XY")
#define MSG_MOVE_X                          _UxGT("D茅pl. X")
#define MSG_MOVE_Y                          _UxGT("D茅pl. Y")
#define MSG_MOVE_Z                          _UxGT("D茅pl. Z")
#define MSG_MOVE_E                          _UxGT("Extrudeur")
#define MSG_MOVE_01MM                       _UxGT("D茅pl. 0.1mm")
#define MSG_MOVE_1MM                        _UxGT("D茅pl. 1mm")
#define MSG_MOVE_10MM                       _UxGT("D茅pl. 10mm")
...
#define MSG_CONTROL                         _UxGT("Contr么ler")
...
#define MSG_OFF                             _UxGT("Arr锚t")
#define MSG_PID_P                           _UxGT("PID-P")
#define MSG_PID_I                           _UxGT("PID-I")
#define MSG_PID_D                           _UxGT("PID-D")
#define MSG_PID_C                           _UxGT("PID-C")
#define MSG_SELECT                          _UxGT("S茅lectionner")
#define MSG_ACC                             _UxGT("Acc茅l茅ration")
...
#define MSG_VELOCITY                        _UxGT("V茅locit茅")
#define MSG_VMAX                            _UxGT("Vmax ")
#define MSG_VMIN                            _UxGT("Vmin ")
#define MSG_VTRAV_MIN                       _UxGT("V d茅pl. min")
#define MSG_ACCELERATION                    _UxGT("Acc茅l茅ration")
#define MSG_AMAX                            _UxGT("Amax ")
#define MSG_A_RETRACT                       _UxGT("A retrait")
#define MSG_A_TRAVEL                        _UxGT("A d茅pl.")
...
#define MSG_PRINT_ABORTED                   _UxGT("Impr. Annul茅e")
#define MSG_NO_MOVE                         _UxGT("Moteurs bloqu茅s.")
#define MSG_KILLED                          _UxGT("MORT.")
#define MSG_STOPPED                         _UxGT("STOPP脡.")
...
#define MSG_FILAMENTUNLOAD                  _UxGT("D茅charger fil.")
#define MSG_FILAMENTUNLOAD_ALL              _UxGT("D茅charger tout")
#define MSG_INIT_SDCARD                     _UxGT("Init. la carte SD")
#define MSG_CNG_SDCARD                      _UxGT("Changer de carte")
#define MSG_ZPROBE_OUT                      _UxGT("Z sonde hors lit")
#define MSG_SKEW_FACTOR                     _UxGT("Facteur 茅cart")
#define MSG_BLTOUCH                         _UxGT("BLTouch")
#define MSG_BLTOUCH_SELFTEST                _UxGT("Autotest BLTouch")
#define MSG_BLTOUCH_RESET                   _UxGT("RaZ BLTouch")
#define MSG_BLTOUCH_DEPLOY                  _UxGT("D茅ployer BLTouch")
...
#define MSG_ZPROBE_ZOFFSET                  _UxGT("D茅calage Z")
#define MSG_BABYSTEP_X                      _UxGT("Babystep X")
#define MSG_BABYSTEP_Y                      _UxGT("Babystep Y")
#define MSG_BABYSTEP_Z                      _UxGT("Babystep Z")
#define MSG_ENDSTOP_ABORT                   _UxGT("But茅e abandon")
...
#define MSG_HALTED                          _UxGT("IMPR. STOPP脡E")
#define MSG_PLEASE_RESET                    _UxGT("R脿Z. SVP")
...
#define MSG_DELTA_SETTINGS                  _UxGT("R茅glages Delta")
...
#define MSG_3POINT_LEVELING                 _UxGT("Niveau 脿 3 points")
#define MSG_LINEAR_LEVELING                 _UxGT("Niveau lin茅aire")
#define MSG_BILINEAR_LEVELING               _UxGT("Niveau bilin茅aire")
#define MSG_UBL_LEVELING                    _UxGT("Niveau lit unifi茅")
...
#define MSG_CASE_LIGHT                      _UxGT("Lumi猫re caisson")
#define MSG_CASE_LIGHT_BRIGHTNESS           _UxGT("Luminosit茅")

#if LCD_WIDTH >= 20
  #define MSG_INFO_PRINT_COUNT              _UxGT("Nbre impressions")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Termin茅es")
...
#define MSG_M600_TOO_COLD                   _UxGT("M600: Trop froid")
  ...
  #define MSG_FILAMENT_CHANGE_INIT_1        _UxGT("Attente D茅marrage")
  ...
  #define MSG_FILAMENT_CHANGE_UNLOAD_2      _UxGT("d茅charger filament")
  #define MSG_FILAMENT_CHANGE_INSERT_1      _UxGT("Ins茅rer filament")
  ...
  #define MSG_FILAMENT_CHANGE_INSERT_1      _UxGT("Ins茅rer et clic")
