...
#elif F_CPU == 16000000
  #define CPU_ST7920_DELAY_1 DELAY_2_NOP//DELAY_NS(0)//DELAY_2_NOP
  #define CPU_ST7920_DELAY_2 DELAY_2_NOP//DELAY_NS(0)
  #define CPU_ST7920_DELAY_3 DELAY_2_NOP//DELAY_NS(63)
#else
