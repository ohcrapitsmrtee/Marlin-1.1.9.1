#ifndef CAHNGE_LANGUAGE_H
#define CAHNGE_LANGUAGE_H
...
static void lcd_change_lang_man_en()
{
    if(currentfontnameindex!=1)
    {
            set_select_font_index0_to_eeprom();
            currentfontnameindex=0;
            tall_font_correction=0;
    }
}
...
static const char* msg_auto_home_x() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_AUTO_HOME_X);      
  }
  return PSTR(MSG_AUTO_HOME_X);
}
/* MSG_AUTO_HOME_Y */
static const char* msg_auto_home_y() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_AUTO_HOME_Y);      
  }
  return PSTR(MSG_AUTO_HOME_Y);
}
/* MSG_AUTO_HOME_Z */
static const char* msg_auto_home_z() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_AUTO_HOME_Z);      
  }
  return PSTR(MSG_AUTO_HOME_Z);
}
...
static const char* msg_level_bed_waiting() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return KANA_MSG_LEVEL_BED_WAITING;      
  }
  return PSTR(MSG_LEVEL_BED_WAITING);
}
...
static const char* msg_preheat_pla() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_PREHEAT_1);    
  }
//  return PSTR(MSG_PREHEAT_1);
}
/* MSG_PREHEAT_PAL_END */
static const char* msg_preheat_pal_end() {
  switch (currentfontnameindex) {
    case 0:
    ...
    //case 2:
     // return PSTR(KANA_MSG_PREHEAT_2);    
  }
  return PSTR(MSG_PREHEAT_1_END);
}
/* MSG_PREHEAT_PAL_BEDONLYD */
static const char* msg_preheat_pal_bedonly() {
  switch (currentfontnameindex) {
    case 0:
...
static const char* msg_preheat_pla_n() {
  switch (currentfontnameindex) {
    case 0:
      return PSTR(MSG_PREHEAT_1_N);
    case 1:
      return PSTR(CN_MSG_PREHEAT_1_N);
    //case 2:
      //return PSTR(KANA_MSG_PREHEAT_1_N);    
  }
  return PSTR(MSG_PREHEAT_1_N);
}
/* MSG_PREHEAT_1_ALL */
static const char* msg_preheat_pla_all() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_PREHEAT_1_ALL);    
  }
  return PSTR(MSG_PREHEAT_1_ALL);
}
...
static const char* msg_preheat_pla_bedonly() {
  switch (currentfontnameindex) {
    ...
    case 1:
      return PSTR(CN_MSG_PREHEAT_1_BEDONLY);
    //case 2:
      //return PSTR(KANA_MSG_PREHEAT_1_BEDONLY);    
  }
  return PSTR(MSG_PREHEAT_1_BEDONLY);
}
...
static const char* msg_preheat_pla_settings() {
  switch (currentfontnameindex) {
    ...
    //case 2:
     // return PSTR(KANA_MSG_PREHEAT_1_SETTINGS);    
  }
  return PSTR(MSG_PREHEAT_1_SETTINGS);
}
/* MSG_PREHEAT_ABS */
...
/* MSG_PREHEAT_ABS_END */
static const char* msg_preheat_abs_end() {
  switch (currentfontnameindex) {
    case 0:
...
static const char* msg_preheat_abs_n() {
  switch (currentfontnameindex) {
    case 0:
      return PSTR(MSG_PREHEAT_2_N);
    case 1:
      return PSTR(CN_MSG_PREHEAT_2_N);
    //case 2:
      //return PSTR(KANA_MSG_PREHEAT_2_N);    
  }
  return PSTR(MSG_PREHEAT_2_N);
}
/* MSG_PREHEAT_ABS_ALL */
static const char* msg_preheat_abs_all() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_PREHEAT_2_ALL);    
  }
  return PSTR(MSG_PREHEAT_2_ALL);
}
...
static const char* msg_preheat_abs_settings() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_PREHEAT_2_SETTINGS);    
  }
  return PSTR(MSG_PREHEAT_2_SETTINGS);
}
/* MSG_NOZZLE_H1 */
...
static const char* msg_level_bed() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_LEVEL_BED);    
  }
  return PSTR(MSG_LEVEL_BED);
}
#endif
...
static const char* msg_vx_jerk() {
  switch (currentfontnameindex) {
    case 0:
      return PSTR(MSG_VA_JERK);
    case 1:
      return PSTR(CN_MSG_VA_JERK);
    //case 2:
     // return PSTR(KANA_MSG_VA_JERK);    
  }
  return PSTR(MSG_VA_JERK);
}
/* MSG_VY_JERK */
static const char* msg_vy_jerk() {
  switch (currentfontnameindex) {
    case 0:
      return PSTR(MSG_VB_JERK);
    case 1:
      return PSTR(CN_MSG_VB_JERK);
    //case 2:
     // return PSTR(KANA_MSG_VB_JERK);    
  }
  return PSTR(MSG_VB_JERK);
}
/* MSG_VZ_JERK */
static const char* msg_vz_jerk() {
  switch (currentfontnameindex) {
    case 0:
      return PSTR(MSG_VC_JERK);
    case 1:
      return PSTR(CN_MSG_VC_JERK);
    //case 2:
      //return PSTR(KANA_MSG_VC_JERK);    
  }
  return PSTR(MSG_VC_JERK);
}
/* MSG_VE_JERK */
...
static const char* msg_vmax_x() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_VMAX MSG_X);    
  }
  return PSTR(MSG_VMAX MSG_X);
}
/* MSG_VMAX_Y */
static const char* msg_vmax_y() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_VMAX MSG_Y);    
  }
  return PSTR(MSG_VMAX MSG_Y);
}
/* MSG_VMAX_Z */
static const char* msg_vmax_z() {
  switch (currentfontnameindex) {
    ...
    //case 2:
     // return PSTR(KANA_MSG_VMAX MSG_Z);    
  }
  return PSTR(MSG_VMAX MSG_Z);
}
/* MSG_VMAX_E */
static const char* msg_vmax_e() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_VMAX MSG_E);    
  }
  return PSTR(MSG_VMAX MSG_E);
}
/* MSG_VMIN */
...
static const char* msg_amax_x() {
  switch (currentfontnameindex) {
    ...
    //case 2:
     // return PSTR(KANA_MSG_AMAX MSG_X);    
  }
  return PSTR(MSG_AMAX MSG_X);
}
/* MSG_AMAX_Y */
static const char* msg_amax_y() {
  switch (currentfontnameindex) {
    ...
    //case 2:
     // return PSTR(KANA_MSG_AMAX MSG_Y);    
  }
  return PSTR(MSG_AMAX MSG_Y);
}
/* MSG_AMAX_Z */
static const char* msg_amax_z() {
  switch (currentfontnameindex) {
    ...
    //case 2:
     // return PSTR(KANA_MSG_AMAX MSG_Z);    
  }
  return PSTR(MSG_AMAX MSG_Z);
}
/* MSG_AMAX_E */
static const char* msg_amax_e() {
  switch (currentfontnameindex) {
    ...
    //case 2:
     // return PSTR(KANA_MSG_AMAX MSG_E);    
  }
  return PSTR(MSG_AMAX MSG_E);
}
/* MSG_A_RETRACT */
...
static const char* msg_steps_per_mm() {
    ...
    //case 2:
     // return PSTR(KANA_MSG_STEPS_PER_MM);    
  }
  return PSTR(MSG_STEPS_PER_MM);
}
/* MSG_XSTEPS */
...
static const char* msg_e5steps() {
  switch (currentfontnameindex) {
    ...
    case 1:
      return PSTR(CN_MSG_E5STEPS);
    //case 2:
      //return PSTR(KANA_MSG_E5STEPS);    
  }
  return PSTR(MSG_E5STEPS);
}
/* MSG_TEMPERATURE */
...
static const char* msg_store_eeprom() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_STORE_EEPROM);    
  }
  return PSTR(MSG_STORE_EEPROM);
}
/* MSG_LOAD_EEPROM */
static const char* msg_load_eeprom() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_LOAD_EEPROM);    
  }
  return PSTR(MSG_LOAD_EEPROM);
}
...
/* MSG_CHANGE_LANGUAGE */
static const char* msg_change_language() {
  switch (currentfontnameindex) {
    case 0:
      return PSTR(MSG_CHANGE_LANGUAGE);
    case 1:
      return PSTR(CN_MSG_CHANGE_LANGUAGE);
    //case 2:
      //return PSTR(KANA_MSG_CHANGE_LANGUAGE);    
  }
  return PSTR(MSG_CHANGE_LANGUAGE);
}
/* MSG_CHANGE_ENGLISH */
static const char* msg_english_lang() {
  switch (currentfontnameindex) {
    case 0:
      return PSTR(MSG_CHANGE_ENGLISH);
    case 1:
      return PSTR(CN_MSG_CHANGE_ENGLISH);
    //case 2:
      //return PSTR(KANA_MSG_CHANGE_ENGLISH);    
  }
  return PSTR(MSG_CHANGE_ENGLISH);
}
/* CN_MSG_CHANGE_ENGLISH */
static const char* msg_chinese_lang() {
  switch (currentfontnameindex) {
    case 0:
      return PSTR(MSG_CHANGE_CHINESE);
    case 1:
      return PSTR(CN_MSG_CHANGE_CHINESE);
    //case 2:
      //return PSTR(KANA_MSG_CHANGE_CHINESE);    
  }
  return PSTR(MSG_CHANGE_ENGLISH);
}
/* KANA_MSG_CHANGE_ENGLISH */
static const char* msg_japanese_lang() {
  switch (currentfontnameindex) {
    case 0:
      return PSTR(MSG_CHANGE_KOREAN);
    case 1:
      return PSTR(CN_MSG_CHANGE_KOREAN);
    //case 2:
     // return PSTR(KANA_MSG_CHANGE_KOREAN);    
  }
  return PSTR(MSG_CHANGE_ENGLISH);
}
/* MSG_REFRESH */
...
static const char* msg_load() {
  switch (currentfontnameindex) {
    ...
    case 1:
      return PSTR(CN_MSG_FILAMENTLOAD);
    //case 2:
      //return PSTR(KANA_MSG_FILAMENTLOAD);    
  }
  return PSTR(MSG_FILAMENTLOAD);
}
/* MSG_FILAMENTUNLOAD */
static const char* msg_unload() {
  switch (currentfontnameindex) {
    ...
    case 1:
      return PSTR(CN_MSG_FILAMENTUNLOAD);
    //case 2:
      //return PSTR(KANA_MSG_FILAMENTUNLOAD);    
  }
  return PSTR(MSG_FILAMENTUNLOAD);
}
/* MSG_INIT_SDCARD */
...
static const char* msg_position_unknown() {
  switch (currentfontnameindex) {
    case 0:
      return PSTR(MSG_UBL_UNHOMED);
    case 1:
      return PSTR(CN_MSG_HOME CN_MSG_FIRST);
    //case 2:
      //return PSTR(KANA_MSG_HOME KANA_MSG_FIRST);    
  }
  return PSTR(MSG_UBL_UNHOMED);
}
#if 0
...
static const char* msg_next() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_LEVEL_BED_NEXT_POINT);    
  }
  return PSTR(MSG_LEVEL_BED_NEXT_POINT);
}
/* MSG_LEVEL_BED_DONE */
static const char* msg_level_bed_done() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_LEVEL_BED_DONE);    
  }
  return PSTR(MSG_LEVEL_BED_DONE);
}
/* MSG_ZPROBE_ZOFFSET */
...
static const char* msg_err_redundant_temp() {
  switch (currentfontnameindex) {
    ...
    //case 2:
     // return PSTR(KANA_MSG_ERR_REDUNDANT_TEMP);    
  }
  return PSTR(MSG_ERR_REDUNDANT_TEMP);
}
/* MSG_THERMAL_RUNAWAY */
static const char* msg_thermal_runaway() {
  switch (currentfontnameindex) {
    ...
    //case 2:
     // return PSTR(KANA_MSG_THERMAL_RUNAWAY);    
  }
  return PSTR(MSG_THERMAL_RUNAWAY);
}
/* MSG_ERR_MAXTEMP */
static const char* msg_err_maxtemp() {
  switch (currentfontnameindex) {
    ...
    //case 2:
      //return PSTR(KANA_MSG_ERR_MAXTEMP);    
  }
  return PSTR(MSG_ERR_MAXTEMP);
}
/* MSG_ERR_MINTEMP */
...
static const char* msg_filament_change_header_pause(){
		switch (currentfontnameindex) {
	  case 0:
		return PSTR(MSG_FILAMENT_CHANGE_HEADER_PAUSE);
	  case 1:
		return PSTR(CN_MSG_FILAMENT_CHANGE_HEADER_PAUSE);
	  //case 2:
		//return PSTR(MSG_FILAMENT_CHANGE_HEADER_PAUSE);	  
	}
	return PSTR(MSG_FILAMENT_CHANGE_HEADER_PAUSE);
}
static const char* msg_filament_change_purge_1(){
		switch (currentfontnameindex) {
	  case 0:
		return PSTR(MSG_FILAMENT_CHANGE_PURGE_1);
	  case 1:
		return PSTR(CN_MSG_FILAMENT_CHANGE_PURGE_1);
	  //case 2:
		//return PSTR(MSG_FILAMENT_CHANGE_PURGE_1);	  
	}
	return PSTR(MSG_FILAMENT_CHANGE_PURGE_1);
}
static const char* msg_filament_change_purge_2(){
		switch (currentfontnameindex) {
	  case 0:
		return PSTR(MSG_FILAMENT_CHANGE_PURGE_2);
	  case 1:
		return PSTR(CN_MSG_FILAMENT_CHANGE_PURGE_2);
	  //case 2:
		//return PSTR(MSG_FILAMENT_CHANGE_PURGE_2);	  
	}
	return PSTR(MSG_FILAMENT_CHANGE_PURGE_2);
...
static const char* msg_filament_change_option_purge(){
		switch (currentfontnameindex) {
	  case 0:
		return PSTR(MSG_FILAMENT_CHANGE_OPTION_PURGE);
	  case 1:
		return PSTR(CN_MSG_FILAMENT_CHANGE_OPTION_PURGE);
	  //case 2:
		//return PSTR(MSG_FILAMENT_CHANGE_OPTION_PURGE);   
	}
	return PSTR(MSG_FILAMENT_CHANGE_OPTION_PURGE);
}
static const char* msg_filament_change_resume_1(){
		switch (currentfontnameindex) {
	  case 0:
		return PSTR(MSG_FILAMENT_CHANGE_RESUME_1);
	  case 1:
		return PSTR(CN_MSG_FILAMENT_CHANGE_RESUME_1);
	  //case 2:
		//return PSTR(MSG_FILAMENT_CHANGE_RESUME_1);   
	}
	return PSTR(MSG_FILAMENT_CHANGE_RESUME_1);
}
static const char* msg_filament_change_resume_2(){
		switch (currentfontnameindex) {
	  case 0:
		return PSTR(MSG_FILAMENT_CHANGE_RESUME_2);
	  case 1:
		return PSTR(CN_MSG_FILAMENT_CHANGE_RESUME_2);
	  //case 2:
		//return PSTR(MSG_FILAMENT_CHANGE_RESUME_2);   
	}
	return PSTR(MSG_FILAMENT_CHANGE_RESUME_2);
