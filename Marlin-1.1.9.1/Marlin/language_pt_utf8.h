...
#define MSG_SD_INSERTED                     _UxGT("Cart茫o inserido")
#define MSG_SD_REMOVED                      _UxGT("Cart茫o removido")
...
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("Pr贸ximo ponto")
...
#define MSG_PREHEAT_1_SETTINGS              _UxGT("Defini莽玫es PLA")
...
#define MSG_PREHEAT_2_SETTINGS              _UxGT("Defini莽玫es ABS")
...
#define MSG_AUTOTEMP                        _UxGT("Temp. Autom谩tica")
...
#define MSG_A_RETRACT                       _UxGT("A-retrac莽茫o")
...
#define MSG_PAUSE_PRINT                     _UxGT("Pausar impress茫o")
#define MSG_RESUME_PRINT                    _UxGT("Retomar impress茫o")
#define MSG_STOP_PRINT                      _UxGT("Parar impress茫o")
#define MSG_CARD_MENU                       _UxGT("Imprimir do SD")
#define MSG_NO_CARD                         _UxGT("Sem cart茫o SD")
#define MSG_DWELL                           _UxGT("Em espera...")
#define MSG_USERWAIT                        _UxGT("脕 espera de ordem")
#define MSG_PRINT_ABORTED                   _UxGT("Impress茫o cancelada")
#define MSG_NO_MOVE                         _UxGT("Sem movimento")
#define MSG_KILLED                          _UxGT("EMERG脢NCIA. ")
...
#define MSG_INIT_SDCARD                     _UxGT("Inici. cart茫o SD")
#define MSG_CNG_SDCARD                      _UxGT("Trocar cart茫o SD")
...
#define MSG_ERR_MAXTEMP                     _UxGT("Err: T M谩xima")
#define MSG_ERR_MINTEMP                     _UxGT("Err: T M铆nima")
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Err: T Base M谩xima")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Err: T Base M铆nima")
#define MSG_HEATING                         _UxGT("Aquecendo...")
#define MSG_BED_HEATING                     _UxGT("Aquecendo base...")
#define MSG_DELTA_CALIBRATE                 _UxGT("Calibra莽茫o Delta")
