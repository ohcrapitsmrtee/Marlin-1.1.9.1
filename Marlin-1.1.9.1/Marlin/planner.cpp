 ...
 * --
 *
 * The fast inverse function needed for B茅zier interpolation for AVR
 * was designed, written and tested by Eduardo Jos茅 Tagle on April/2018
 */
...
uint32_t Planner::max_acceleration_mm_per_s2[XYZE_N],    // (mm/s^2) M201 XYZE
         ...
         Planner::min_segment_time_us;                   // (碌s) M205 B
