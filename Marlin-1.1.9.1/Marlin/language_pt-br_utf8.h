...
#define MSG_LEVEL_BED_DONE                  _UxGT("Fim nivela莽茫o!")
#define MSG_Z_FADE_HEIGHT                   _UxGT("Suavizar altura")
#define MSG_SET_HOME_OFFSETS                _UxGT("Compensar origem")
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("Altera莽茫o feita")
...
#define MSG_BED_LEVELING                    _UxGT("Nivela莽茫o Mesa")
#define MSG_LEVEL_BED                       _UxGT("Nivelar Mesa")
#define MSG_LEVEL_CORNERS                   _UxGT("Nivelar Cantos")
#define MSG_NEXT_CORNER                     _UxGT("Pr贸ximo Canto")
#define MSG_EDITING_STOPPED                 _UxGT("Fim da Edi莽茫o")
...
#define MSG_UBL_BC_INSERT                   _UxGT("Cal莽ar e calibrar")
#define MSG_UBL_BC_INSERT2                  _UxGT("Medir")
#define MSG_UBL_BC_REMOVE                   _UxGT("Remover e calibrar")

#define MSG_UBL_MOVING_TO_NEXT              _UxGT("Indo para o Pr贸ximo")
...
#define MSG_UBL_DONE_EDITING_MESH           _UxGT("Fim da Edi莽茫o")
...
#define MSG_UBL_MESH_HEIGHT_AMOUNT          _UxGT("Tamanho da Eleva莽茫o")
...
#define MSG_UBL_MESH_LEVELING               _UxGT("Nivela莽茫o da Malha")
#define MSG_UBL_3POINT_MESH_LEVELING        _UxGT("Nivela莽茫o 3 pontos")
#define MSG_UBL_GRID_MESH_LEVELING          _UxGT("Nivela莽茫o Grid")
...
#define MSG_UBL_INFO_UBL                    _UxGT("Informa莽茫o do UBL")
...
#define MSG_UBL_INVALIDATE_CLOSEST          _UxGT("Invalidar pr贸ximo")
#define MSG_UBL_FINE_TUNE_ALL               _UxGT("Ajuste Fino de Todos")
#define MSG_UBL_FINE_TUNE_CLOSEST           _UxGT("Ajuar Mais Pr贸ximo")
#define MSG_UBL_STORAGE_MESH_MENU           _UxGT("Armazenamento Malha")
#define MSG_UBL_STORAGE_SLOT                _UxGT("Slot de Mem贸ria")
...
#define MSG_UBL_Z_OFFSET_STOPPED            _UxGT("Compensa莽茫o Z parou")
...
#define MSG_LED_PRESETS                     _UxGT("Configura莽茫o da Luz")
...
#define MSG_SET_LEDS_DEFAULT                _UxGT("Luz Padr茫o")
...
#define MSG_VOLUMETRIC_ENABLED              _UxGT("Extrus茫o em mm3")
#define MSG_FILAMENT_DIAM                   _UxGT("Di芒metro Fil.")
#define MSG_ADVANCE_K                       _UxGT("Avan莽ar K")
#define MSG_CONTRAST                        _UxGT("Contraste")
#define MSG_STORE_EEPROM                    _UxGT("Salvar Configura莽茫o")
#define MSG_LOAD_EEPROM                     _UxGT("Ler Configura莽茫o")
#define MSG_RESTORE_FAILSAFE                _UxGT("Restauro seguro")
#define MSG_INIT_EEPROM                     _UxGT("Iniciar EEPROM")
#define MSG_REFRESH                         LCD_STR_REFRESH _UxGT(" Atualiza莽茫o")
#define MSG_WATCH                           _UxGT("Informa莽玫es")
#define MSG_PREPARE                         _UxGT("Preparar")
#define MSG_TUNE                            _UxGT("Ajustar")
#define MSG_PAUSE_PRINT                     _UxGT("Pausar impress茫o")
#define MSG_RESUME_PRINT                    _UxGT("Resumir impress茫o")
...
#define MSG_PRINT_ABORTED                   _UxGT("Impress茫o Abortada")
#define MSG_NO_MOVE                         _UxGT("Sem movimento")
#define MSG_KILLED                          _UxGT("PARADA DE EMERG脢NCIA")
...
#define MSG_AUTORETRACT                     _UxGT("Retra莽茫o Autom谩tica")
...
#define MSG_THERMAL_RUNAWAY                 _UxGT("ESCAPE T脡RMICO")
#define MSG_ERR_MAXTEMP                     _UxGT("Erro:Temp M谩xima")
#define MSG_ERR_MINTEMP                     _UxGT("Erro:Temp M铆nima")
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Erro:Temp Mesa M谩x")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Erro:Temp Mesa M铆n")
...
#define MSG_DELTA_SETTINGS                  _UxGT("Configura莽茫o Delta")
#define MSG_DELTA_AUTO_CALIBRATE            _UxGT("Auto-Calibra莽茫o")
...
#define MSG_DRIVE_STRENGTH                  _UxGT("For莽a do Motor")
...
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Continuar Impress茫o")
#define MSG_FILAMENT_CHANGE_MINTEMP         _UxGT("Temp. M铆nima 茅 ")
#define MSG_FILAMENT_CHANGE_NOZZLE          _UxGT("  Bocal: ")
#define MSG_ERR_HOMING_FAILED               _UxGT("Falha ao ir 脿 origem")
#define MSG_ERR_PROBING_FAILED              _UxGT("Falha ao sondar")
  ...
  #define MSG_FILAMENT_CHANGE_UNLOAD_2      _UxGT("remo莽茫o de filamento")

  #define MSG_FILAMENT_CHANGE_INSERT_1      _UxGT("Coloque Filamento")
  #define MSG_FILAMENT_CHANGE_INSERT_2      _UxGT("pressione o bot茫o")
  #define MSG_FILAMENT_CHANGE_INSERT_3      _UxGT("para continuar...")

  #define MSG_FILAMENT_CHANGE_HEAT_1        _UxGT("Pressione o bot茫o")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1     _UxGT("Esperando extrus茫o")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2     _UxGT("de filamento")

  #define MSG_FILAMENT_CHANGE_RESUME_1      _UxGT("Esperando impress茫o")
